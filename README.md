...
Path Parameter â€” Azure subscription ID

resourceGroupName (required)

Path Parameter â€” The name of the resource group within the user's
subscription. The name is case insensitive.

workspaceName (required)

Path Parameter â€” The name of the workspace.

ruleId (required)

Path Parameter â€” Alert rule ID
...
Query Parameter â€” API version for the operation
...
Body Parameter â€” The alert rule
...
Body Parameter â€” The data connector
